...
if workshopRef.Is3DLoaded() == false && workshopRef.OwnedByPlayer
	...
	MessageManager.ShowMessage(WorkshopRaiderAttack02Message, akQuestRef = kmyQuest, aiObjectiveID = 10, aiStageCheck = 100)
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		MessageManager.ShowMessage(WorkshopRaiderAttack02LoseMessage)
		;WorkshopRaiderAttack02LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		MessageManager.ShowMessage(WorkshopRaiderAttack02WinMessage)
