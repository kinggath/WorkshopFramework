; ---------------------------------------------
; WorkshopFramework:Library:ObjectRefs:ProtectedObjectRef.psc - by kinggath
; ---------------------------------------------
; Reusage Rights ------------------------------
...
Scriptname WorkshopFramework:Library:ObjectRefs:ProtectedObjectRef extends WorkshopFramework:Library:ObjectRefs:LockableObjectRef
