; ---------------------------------------------
; WorkshopFramework:Library:ObjectRefs:LockableObjectRef.psc - by E
; ---------------------------------------------
; Reusage Rights ------------------------------
...
Scriptname WorkshopFramework:Library:ObjectRefs:LockableObjectRef extends ObjectReference
