...
Scriptname WorkshopFramework:Fragments:Terminals:TERM_WSFW_Options_Menu_Functionality Extends Terminal Hidden Const

;BEGIN FRAGMENT Fragment_Terminal_01
Function Fragment_Terminal_01(ObjectReference akTerminalRef)
;BEGIN CODE
Setting_AdjustMaxNPCsByCharisma.SetValue(0.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_AdjustMaxNPCsByCharisma.SetValue(1.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_LinkedSettlementConsumption.SetValue(0.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_LinkedSettlementConsumption.SetValue(1.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RecruitSettlersImmediately.SetValue(0.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RecruitSettlersImmediately.SetValue(1.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotsCountTowardsMaxPopulation.SetValue(0.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotsCountTowardsMaxPopulation.SetValue(1.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(5.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(10.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(15.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(20.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(25.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(30.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(35.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(40.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(45.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(50.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(55.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(60.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(65.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(70.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(75.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(80.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(85.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(90.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(95.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(100.0)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Setting_RobotHappinessLevel.SetValue(0.0)
;END CODE
EndFunction
;END FRAGMENT
...
GlobalVariable Property Setting_LinkedSettlementConsumption Auto Const

GlobalVariable Property Setting_RecruitSettlersImmediately Auto Const
